...
class MCPClientBridge extends MCPJobRunnerOwner
{
	...
	protected const string CLIENT_POLL_CAPS = "action_use,camera_get,camera_set,engine_set,key_press,player_respawn," + "restore_gameplay,ui_click,ui_dialog,ui_focus,ui_reload_layout,ui_set_text,ui_tree," + "vehicle_control,vehicle_get_in_client,vehicle_release,vehicle_telemetry,vehicle_trace";
